...
console.log("el",el.imageUrl)
    return (
        ...
        className='carouseledit'>
          ...
          <div style={{height:'20%',fontSize: "19px", fontWeight: "600", textAlign:'center'}} ><h4>{el.titre?el.titre:"titre"}</h4></div>
          <div style={{height:'20%'}}>{el.typeJob?el.typeJob:[]}</div>
          <div style={{height:'20%' ,display: "flex", flexDirection: "row", padding: "0px 10px 0px 5px" }}>
            <div style={{display:'flex', flexDirection:'row', width:'50%'}}><FontAwesomeIcon
            color="gray"
            size="lg"
            className="btnicon"
            icon={faMapMarkerAlt}
          /><p style={{marginLeft:'5px'}} >{el.adresse?el.adresse:"adresse"}</p></div>
          ...
          <div style={{display:'flex', flexDirection:'row',height:'40%', padding:"5px"}}>
          <FontAwesomeIcon
            color="gray"
            size="lg"
            className="btnicon"
            icon={faAddressCard}
          />
             <p style={{}}>{el.description?el.description:"description"}</p></div>
            </div>
            <div style={{
              width:"5%",
          display: "flex",
          ...
          <button onClick={handelDeleteFavorit} style={{border:'none', backgroundColor: "#f8f9fa",marginLeft:"-5px"}}> <FontAwesomeIcon
          color={"orange"}
          size="lg"
          className="btnicon"
          icon={solidstar}
        /></button>:<button onClick={handelAddFavorit} style={{border:'none', backgroundColor: "#f8f9fa",marginLeft:"-5px"}} > <FontAwesomeIcon
        color={"gray"}
        size="lg"
        className="btnicon"
        icon={regularstar}
      ...
      {user&&user._id==el.Auth?<button onClick={handelDelete} style={{backgroundColor: "#f8f9fa",marginTop:'10px', border:'none',marginLeft:"-4px"}}><FontAwesomeIcon
          color="gray"
          className="btnicon"
          icon={faTrashAlt}
        /></button>:null}
